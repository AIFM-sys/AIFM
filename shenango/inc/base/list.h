...
static inline void __list_add(struct list_node *prev,
			      struct list_node *n,
...
static inline void list_add_after(struct list_node *prev, struct list_node *n)
{
	__list_add(prev, n, prev->next);
}

static inline void list_add_before(struct list_node *next, struct list_node *n)
{
	__list_add(next->prev, n, next);
}
...
static inline bool list_empty_no_lock(const struct list_head *h)
{
	return h->n.next == &h->n;
}
...
static inline bool slist_empty(const struct slist_head *h)
{
