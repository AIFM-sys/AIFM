...
#ifndef _BSD_SYS_SYSPROTO_H_
#define	_BSD_SYS_SYSPROTO_H_

#include <sys/bsd_signal.h>
#include <sys/bsd_acl.h>
#include <sys/bsd_cpuset.h>
#include <sys/bsd__semaphore.h>
#include <sys/bsd_ucontext.h>

#include <bsm/bsd_audit_kevents.h>
