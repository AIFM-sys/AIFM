#ifndef lint
static char rcsid[] = "$Header: /cvs/bao-parsec/ext/splash2x/apps/volrend/src/libtiff/mkg3states.c,v 1.1.1.1 2012/03/29 17:22:43 uid42307 Exp $";
#endif
 ...
 *
 *	Reference: $Id: mkg3states.c,v 1.1.1.1 2012/03/29 17:22:43 uid42307 Exp $
 *
